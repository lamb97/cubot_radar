//
// Created by godzhu on 2021/11/25.
//
#include <iostream>
#include <ros/ros.h>
...
int main(int argc, char** argv)
{
    ...
    // ros节点初始化
    ros::init(argc, argv, "multi_sensor_subscriber");

    // 创建ros句柄
    ros::NodeHandle nh;

    // 定义一个接受图像话题信息的消息过滤器   
    message_filters::Subscriber<sensor_msgs::Image> imageSub(nh, "camera/image", 2);
    ...
    // 定义时间同步器的消息队列大小和接收话题
    message_filters::Synchronizer<MySyncPolicy> sync(MySyncPolicy(80), imageSub, pointCloudSub);
